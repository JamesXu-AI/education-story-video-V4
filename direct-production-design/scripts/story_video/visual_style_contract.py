...
POSITIVE_LOOK_LOCKS = (
    ...
    "Every character asset is a full-body final-look portrait; show props or accessories only when production design has selected them for current story, identity or continuity needs. The face, gaze and species-appropriate posture show motivated expression, attention and thought rather than a neutral catalogue pose.",
    "Every non-human character uses the task-authored natural species body plan and locomotion: quadrupeds remain quadrupeds, insects retain their natural leg and wing plan, and birds retain two legs plus two wings; never humanize an animal with an upright bipedal torso, arms, hands, or feet.",
...
NEGATIVE_PROMPT_LOCKS = (
    ...
    "No neutral-model character portrait, blank wildlife stare, fixed catalogue smile, missing thought, humanized animal torso, upright animal biped, animal arms, animal hands, or natural-species topology drift; a deliberately prop-free final-look portrait is valid.",
