...
def silent_group_portrait_brief(
    *,
    ...
    brief = (
        ...
        "plan. Anthropomorphic inner life belongs in expression, gaze, attention, and "
        "pose; it never authorizes extra limbs. A natural quadruped has exactly four "
        ...
        "catalogue smile. Use readable poses on a plain warm background, with no story "
        "action, location, text, border, or logo. EXACT ORDERED MEMBER TYPES JSON: "
